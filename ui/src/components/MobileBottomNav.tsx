...
export function MobileBottomNav({ visible }: MobileBottomNavProps) {
  ...
  const items = useMemo<MobileNavItem[]>(
    () => [
      { type: "link", to: "/dashboard", label: t("navigation.dashboard"), icon: House },
      { type: "link", to: "/issues", label: t("navigation.issues"), icon: CircleDot },
      { type: "action", label: t("navigation.newIssue"), icon: SquarePen, onClick: () => openNewIssue() },
      { type: "link", to: "/agents/all", label: t("org.list.title"), icon: Users },
      {
        type: "link",
        to: "/inbox",
